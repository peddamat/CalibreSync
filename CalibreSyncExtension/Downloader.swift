...
//
//  Created by Sumanth Peddamatham on 12/20/18.
...
class Downloader: NSObject {
    ...
    @discardableResult
    func download(url:URL, identifier: NSFileProviderItemIdentifier, completionHandler ch : @escaping DownloaderCH) -> URLSessionTask {
        ...
        NSFileProviderManager.default.register(task, forItemWithIdentifier: identifier, completionHandler: { (error: Error?) in
            print("Starting download for: " + identifier.rawValue)
        })
